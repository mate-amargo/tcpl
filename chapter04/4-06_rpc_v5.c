...
/*
 * To avoid processing more characters I've changed commands to be all upercase
 * letters, and variables will be lowercase letters. I'll use '_' to print the
 * most recently printed value. A single lowercase letter puts the value of
 * that variable to the stack. Meanwhile an equals sign followed by a lowercase
 * letter, assings the value of the previous operation to the given variable.
 */
